...
public sealed partial class RequirementFactory
{
    ...
    public RequirementFactory(IServiceProvider sp, ClassConfiguration classConfig)
    {
        ...
        intVariables = new Dictionary<string, Func<int>>
        {
            ...
            { "FocusMinRange", playerReader.FocusMinRange },
            { "FocusMaxRange", playerReader.FocusMaxRange },
            { "PartyMember1MinRange", playerReader.PartyMember1MinRange },
            { "PartyMember1MaxRange", playerReader.PartyMember1MaxRange },
            { "PartyMember2MinRange", playerReader.PartyMember2MinRange },
            { "PartyMember2MaxRange", playerReader.PartyMember2MaxRange },
            { "PartyMember3MinRange", playerReader.PartyMember3MinRange },
            { "PartyMember3MaxRange", playerReader.PartyMember3MaxRange },
            { "PartyMember4MinRange", playerReader.PartyMember4MinRange },
            { "PartyMember4MaxRange", playerReader.PartyMember4MaxRange },
