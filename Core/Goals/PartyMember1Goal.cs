...
public sealed class PartyMember1Goal : GoapGoal
{
    private readonly ILogger<PartyMember1Goal> logger;
    ...
    public PartyMember1Goal(ILogger<PartyMember1Goal> logger,
        ...
        : base(nameof(PartyMember1Goal))
    {
        ...
        this.Keys = classConfig.PartyMember1.Sequence;
        this.restHandler = restHandler;
        this.chatReader = chatReader;

        AddPrecondition(GoapKey.party1connected, true);
